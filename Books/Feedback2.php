...
session_start();
		if (isset($_REQUEST["submit"])) {
			...
			$huname = $_REQUEST['uname'];
			$hdata = $_REQUEST['feed'];

			$str = "insert into feedback(fname,fdata) values('".$huname."','". $hdata."')";
...
<br>
<h1 style="text-align: center; color: white"><i class="glyphicon glyphicon-edit"></i></h1>
	<h1 style="text-align: center; color: white">Feedback</h1>
								...
								<form method="post" name="loginform">
									<div class="container" style="width:480px; height:500px;">
										...
										<div class="">
												...
												<input type="text" placeholder="Your feedback" name="feed" required class="form-control"/> 
										</div>
								<br>
										<div class="">
												<button style="color:#FFFFFF; background-color:#82B440; border-color:#82B440;" type="submit" name="submit">Submit</button>
										</div><br>
