...
<div id="pageintro" class="hoc clear">
    <!-- ################################################################################################ -->
        ...
        <h3 style="color:#82B440">Why do I need to register on the site?</h3>
        <h5>Establishing an online account eases your task for finding used books at appropriate price.</h5>
        <br><br>
				<h3 style="color:#82B440">How to Search for products within the bookstore?</h3>
				<h4>Browse:</h4><h5>To find all published resources based on departments and categories, </br>click on the dark gray tabs in the upper navigation of the bookstore.
</div>
