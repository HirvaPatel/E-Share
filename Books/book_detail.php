...
<!-- ################################################################################################ -->
    <!-- ################################################################################################ -->
				...
				<div class="wrapper row4" style="background-image:url('images/demo/backgrounds/stack-of-books.jpg');">

						<div class="hoc container clear">
        <ul class="nospace elements">
<?php
					$name=$_GET['book'];
					$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where name='".$name."'");
					//display
...
$dept=$results['dept'];
                                echo '<li class="one_third">
                                  <article><figure><img style="height:380px;width:500px" src="getImage.php?name='.$name.'" alt="book photo"/>
                                  <figcaption><a href="profile.php?seller='.$uname.'& bid='.$bid.' ">View Details &raquo;</a></figcaption>
                                    </figure>
                                    <div class="txtwrap">
                                      <h6 class="heading">'.$name.'</h6>
																			<table><tr><td>Author</td><td>'.$author.'</td>
																			<tr><td>Category </td><td>'.$category.'</td>
																			<tr><td>Price </td><td>'.$price.'</td></tr></table>
																			<p style="color:#82B440">Added By: '.$uname.'</p>
		             ...
		             <p  style="text-color:#82B440;"> No results found</p>
		              </div>
		          </div>
							';
						}
        ...
        echo '</ul></div></div>
				<div class="wrapper row3" >
					...
					<div class="center btmspace-80">
						<h2 class="heading font-x3">Related books</h2>
					</div>
						<div class="group center">';

				$raw_results2 = mysqli_query($con,"SELECT * FROM `book_details` where dept='".$dept."'");
			//display
			if(mysqli_num_rows($raw_results2) > 0){ // if one or more rows are returned do following
													...
													if($name != $name2){
														echo '<i class="icon fa fa-book"></i>
																<h4 class="font-x1 uppercase" style="color:#82B440;font-size:16px;"><a href="book_detail.php?book='.$name2.'">'.$name2.'</a></h4>
														 </article>';}else echo'</article>';
														$count++;}}
