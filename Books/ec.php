    ...
    <ul class="nospace inline pushright">
      <?php
        ...
        if( isset( $_SESSION['login_status']) ){
          ...
          echo '<li><a class="btn" href="profile.php"><span class="glyphicon glyphicon-user"></span>'.$_SESSION['usr_name'].'</a></li>';
			...
			<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/stack-of-books.jpg');">
			  ...
			  <div id="pageintro" class="hoc clear">
			    ...
			    <article class="introtxt">
			      <h2 class="heading">Electronics and Communication</h2>
			      <p>Connecting the possibilites</p>
			    </article>
			    <!-- ################################################################################################ -->
			  </div>
        ...
        <form class="navbar-form navbar-left" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="sem">
          ...
          <?php
					if(isset($_POST['search'])){
						...
						if($sem!=0){
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where dept='EC' and sem=$sem");
					}else{
            $raw_results = mysqli_query($con,"SELECT * FROM `book_details` where dept='EC'");
				  }}
					else{
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where dept='EC'");
					}
